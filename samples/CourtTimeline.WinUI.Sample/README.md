...
| --- | --- |
| Демонстрационное дело | Закрытая стадия, окно до факта, срок впереди и ещё не начатая кассация |
| Без обещанного срока | Открытый край на сегодня и хвост только до назначенного заседания |
| Срок ещё впереди | Сплошной факт до сегодня и штриховка до заданного срока |
| Срок уже прошёл | Просроченный срок без штриховки в прошлое, маркер на сегодня |
| Стадия закрыта | Факт до даты закрытия, сегодня правее полосы, окно слева |
| Ещё не началась | Целиком пунктирная возможная стадия и плановое событие |
...
Масштаб и «Весь процесс» — элементы самой библиотеки. Переключение набора данных восстанавливает масштаб 1. «Сбросить» возвращает все настройки и первое дело. Проверяйте также изменение размеров окна, Tab/Enter/Space и системную высокую контрастность.
