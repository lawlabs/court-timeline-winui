...
Сверху доступны системная/светлая/тёмная тема, русский/английский язык компонента, показ шапки и деталей. Флажок «Сейчас» ведёт линию «сегодня» по часам компьютера; без него дата и время задаются рядом. Авторский текст демоданных остаётся русским. Внизу отображается результат события `SelectionChanged`, в том числе когда встроенная панель деталей выключена.
